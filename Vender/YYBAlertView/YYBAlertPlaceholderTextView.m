...
@implementation YYBAlertPlaceholderTextView
...
- (instancetype)init {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(YYBTextDidChanged:) name:UITextViewTextDidChangeNotification object:nil];
    
    return self;
}

- (void)YYBTextDidChanged:(UITextView *)textView {
