...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    _checkButton = [UIButton buttonWithSuperView:self.contentView constraint:^(MASConstraintMaker *make) {
        ...
        [button setBackgroundImage:[UIImage imageNamed:@"ic_check_no"] forState:0];
        [button setBackgroundImage:[UIImage imageNamed:@"ic_check_yes"] forState:UIControlStateSelected];
